...
-- Description: Baseline schema dari setup_tables.sql yang sudah berjalan di production
-- Created: 2025-12-26

-- =========================================================
-- 1. TABEL MASTER: DEVICES
-- =========================================================
...
-- =========================================================
-- 2. VIEW: DEVICES WITH REAL-TIME STATUS
-- =========================================================
...
-- =========================================================
CREATE TABLE IF NOT EXISTS attendance_logs_history PARTITION OF attendance_logs
  FOR VALUES FROM (MINVALUE) TO ('2025-12-01 00:00:00');

-- =========================================================
-- 5. PARTISI: DATA MASA DEPAN (BULANAN)
-- =========================================================
CREATE TABLE IF NOT EXISTS attendance_logs_2025_12 PARTITION OF attendance_logs
  FOR VALUES FROM ('2025-12-01 00:00:00') TO ('2026-01-01 00:00:00');

CREATE TABLE IF NOT EXISTS attendance_logs_2026_01 PARTITION OF attendance_logs
  FOR VALUES FROM ('2026-01-01 00:00:00') TO ('2026-02-01 00:00:00');

CREATE TABLE IF NOT EXISTS attendance_logs_2026_02 PARTITION OF attendance_logs
  FOR VALUES FROM ('2026-02-01 00:00:00') TO ('2026-03-01 00:00:00');

CREATE TABLE IF NOT EXISTS attendance_logs_2026_03 PARTITION OF attendance_logs
  FOR VALUES FROM ('2026-03-01 00:00:00') TO ('2026-04-01 00:00:00');

CREATE TABLE IF NOT EXISTS attendance_logs_2026_04 PARTITION OF attendance_logs
  FOR VALUES FROM ('2026-04-01 00:00:00') TO ('2026-05-01 00:00:00');

CREATE TABLE IF NOT EXISTS attendance_logs_2026_05 PARTITION OF attendance_logs
  FOR VALUES FROM ('2026-05-01 00:00:00') TO ('2026-06-01 00:00:00');

CREATE TABLE IF NOT EXISTS attendance_logs_2026_06 PARTITION OF attendance_logs
  FOR VALUES FROM ('2026-06-01 00:00:00') TO ('2026-07-01 00:00:00');

CREATE TABLE IF NOT EXISTS attendance_logs_2026_07 PARTITION OF attendance_logs
  FOR VALUES FROM ('2026-07-01 00:00:00') TO ('2026-08-01 00:00:00');

CREATE TABLE IF NOT EXISTS attendance_logs_2026_08 PARTITION OF attendance_logs
...
CREATE TABLE IF NOT EXISTS attendance_logs_2026_10 PARTITION OF attendance_logs
  FOR VALUES FROM ('2026-10-01 00:00:00') TO ('2026-11-01 00:00:00');

CREATE TABLE IF NOT EXISTS attendance_logs_2026_11 PARTITION OF attendance_logs
  FOR VALUES FROM ('2026-11-01 00:00:00') TO ('2026-12-01 00:00:00');

-- Partisi DEFAULT
CREATE TABLE IF NOT EXISTS attendance_logs_default PARTITION OF attendance_logs DEFAULT;

-- =========================================================
-- 6. INDEXING (OPTIMASI PERFORMA)
-- =========================================================
CREATE INDEX IF NOT EXISTS idx_attendance_logs_check_time ON attendance_logs(check_time DESC);
CREATE INDEX IF NOT EXISTS idx_attendance_logs_user_pin ON attendance_logs(user_pin);
CREATE INDEX IF NOT EXISTS idx_att_device_time ON attendance_logs (device_sn, check_time DESC);
...
CREATE INDEX IF NOT EXISTS idx_device_commands_pending ON device_commands(device_sn, status) WHERE status = 'pending';
